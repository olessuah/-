...
namespace Web_Service.Controllers
{
    ...
    {
        private readonly PoliceStationsdbMainContext db;
        private string datanumber = "2354",
                       api_key = "c053ecce71aab24f75b2a275f47e929f";

        public DataController(PoliceStationsdbMainContext context)
        {
            db = context;
        }
